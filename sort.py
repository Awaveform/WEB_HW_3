...
# # def move_file(category, file_path, root_path):
# #     new_file_path = root_path / pathlib.Path(category) / f"{file_path.stem}{file_path.suffix}"
# #     if new_file_path.exists():
# #         index = 1
# #         while True:
# #             new_file_path = root_path / pathlib.Path(category) / f"{file_path.stem}({index}){file_path.suffix}"
# #             if new_file_path.exists():
# #                 index += 1
# #                 continue
# #             break
...
# #             if set(file_path.parts).intersection(set(actual_file_paths.keys())):
# #                 continue
# #             future = executor.submit(move_file, category, file_path, root_path)
...
# def move_files_to_its_category_dir(category, file_path, root_path):
#     new_file_path = root_path / pathlib.Path(category) / f"{file_path.stem}{file_path.suffix}"
#     if new_file_path.exists():
#         index = 1
#         while True:
